...
_FLASK_REACT = StackProfile(
    ...
    architect_instructions=(
        ...
        "Enable CORS in the Flask app factory for all origins (use CORS(app) with no restrictions). "
        "The Vite dev-server proxies /api to the Flask backend.\n"
        "Backend port: read from os.environ.get('PORT', 9000) — NEVER hardcode a port number.\n"
        "Frontend port: set by the --port flag passed to vite — do not hardcode in vite.config.js.\n"
